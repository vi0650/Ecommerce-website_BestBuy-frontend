          ...
          {!isFetching ? data?.products?.length > 0 ? <div>
            ...
            <thead>
                    <tr className="border-b border-gray-800 text-left">
                       <th className="p-3 uppercase text-sm font-medium text-gray-300">name</th>
                       <th className="p-3 uppercase text-sm font-medium text-gray-300">price</th>
                       <th className="p-3 uppercase text-sm font-medium text-gray-300">stock</th>
                       <th className="p-3 uppercase text-sm font-medium text-gray-300">image</th>
                       <th className="p-3 uppercase text-sm font-medium text-gray-300">edit</th>
                       <th className="p-3 uppercase text-sm font-medium text-gray-300">delete</th>
                    </tr>
                 </thead>
                 <tbody>
                  {data?.products?.map(product => (
                     <tr className="odd:bg-gray-800" key={product._id}>
                        ...
                        <td className="p-3 capitalize text-sm font-normal text-gray-400">
                           <img src={`/images/${product.image1}`} alt="image name" className="w-20 h-20 object-cover object-top rounded-md" />
                        </td>
